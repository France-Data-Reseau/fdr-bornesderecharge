...
select
       ...
       #}
        ...
        ST_GeomFROMText('POINT(' || replace(substr("coordonneesXY", 2, length("coordonneesXY") - 2), ',', ' ') || ')', 4326) as geometry as "{{ fieldPrefix }}coordonneesXY", -- [2.400428, 48.840687]
        {{ fdr_appuiscommuns.to_numeric_or_null('nbre_pdc', source_relation, source_alias) }}::numeric }}  as "{{ fieldPrefix }}nbre_pdc", -- 10
        "id_pdc_itinerance"::text as "{{ fieldPrefix }}id_pdc_itinerance", -- FRA68P680210015
        "id_pdc_local"::text as "{{ fieldPrefix }}id_pdc_local", --
        {{ fdr_appuiscommuns.to_numeric_or_null('puissance_nominale', source_relation, source_alias) }}::numeric }} as "{{ fieldPrefix }}puissance_nominale", -- 22
        {{ fdr_appuiscommuns.to_boolean_or_null('prise_type_ef', source_relation, source_alias) }} as "{{ fieldPrefix }}prise_type_ef", -- true
        {{ fdr_appuiscommuns.to_boolean_or_null('prise_type_2', source_relation, source_alias) }} as "{{ fieldPrefix }}prise_type_2", -- true
        {{ fdr_appuiscommuns.to_boolean_or_null('prise_type_combo_ccs', source_relation, source_alias) }} as "{{ fieldPrefix }}prise_type_combo_ccs", -- false
        {{ fdr_appuiscommuns.to_boolean_or_null('prise_type_chademo', source_relation, source_alias) }} as "{{ fieldPrefix }}prise_type_chademo", -- false
        {{ fdr_appuiscommuns.to_boolean_or_null('prise_type_autre', source_relation, source_alias) }} as "{{ fieldPrefix }}prise_type_autre", -- false
        {{ fdr_appuiscommuns.to_boolean_or_null('gratuit', source_relation, source_alias) }} as "{{ fieldPrefix }}gratuit", -- false
        {{ fdr_appuiscommuns.to_boolean_or_null('paiement_acte', source_relation, source_alias) }} as "{{ fieldPrefix }}paiement_acte", -- true
        {{ fdr_appuiscommuns.to_boolean_or_null('paiement_cb', source_relation, source_alias) }} as "{{ fieldPrefix }}paiement_cb", -- true
        {{ fdr_appuiscommuns.to_boolean_or_null('paiement_autre', source_relation, source_alias) }} as "{{ fieldPrefix }}paiement_autre", -- true
        "tarification"::text as "{{ fieldPrefix }}tarification", -- 0.40€ / kwh
        "condition_acces"::text as "{{ fieldPrefix }}condition_acces", -- Accès libre
        {{ fdr_appuiscommuns.to_boolean_or_null('reservation', source_relation, source_alias) }} as "{{ fieldPrefix }}reservation", -- true
        ...
        {{ fdr_appuiscommuns.to_boolean_or_null('station_deux_roues', source_relation, source_alias) }} as "{{ fieldPrefix }}station_deux_roues", -- true
        ...
        {{ fdr_appuiscommuns.to_date_or_null('date_mise_en_service', source_relation, ['YYYY-MM-DD'], source_alias) }}::date as "{{ fieldPrefix }}date_mise_en_service", -- 2020-01-14
        "observations"::text as "{{ fieldPrefix }}observations", --
        {{ fdr_appuiscommuns.to_date_or_null('date_maj', source_relation, ['YYYY-MM-DD'], source_alias) }}::date as "{{ fieldPrefix }}date_maj" -- 2021-04-05
